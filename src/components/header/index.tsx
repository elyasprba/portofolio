  ...
  return (
    <>
      <header>
        ...
        <div className="flex gap-2 pt-8 pb-8 items-center flex-wrap max-w-3xl mx-8 sm:mx-14">
          <Icon
          ...
          <a
            href="#"
            className="py-1 px-4 sm:py-2 bg-gray-200 rounded-xl flex items-center justify-center hover:bg-gray-300 transition-colors"
          >
